...
const Layout = ({ children }: Props) => {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen duration-500 dark:selection:bg-palevioletred selection:text-white dark:bg-bgGray selection:bg-pink-300">
