...
const Layout = ({ children }: Props) => {
  ...
  return (
    <div
      className="flex flex-col items-center h-full min-h-screen duration-500 dark:bg-gray-500 selection:bg-pink-300 selection:text-white dark:selection:bg-palevioletred"
      style={{
        opacity: "0.9",
    ...
    >
      ...
      <div className="flex flex-col justify-center items-center px-4 w-full max-w-full min-h-screen md:overflow-x-visible md:px-8 lg:py-4 md:max-w-10xl">
        <Navbar />
