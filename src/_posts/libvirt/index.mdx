...
- <ScreenshotLink
    ...
    text="https://en.wikipedia.org/wiki/QEMU"
    className="reset"
  />
- <ScreenshotLink
    url="https://wiki.archlinux.org/title/libvirt#Management"
    text="https://wiki.archlinux.org/title/libvirt#Management"
    className="reset"
  />
- <ScreenshotLink
    url="https://linux.die.net/man/1/virt-install"
    text="https://linux.die.net/man/1/virt-install"
    className="reset"
  />
- <ScreenshotLink
    url="https://computingforgeeks.com/how-to-create-and-configure-bridge-networking-for-kvm-in-linux/"
    text="https://computingforgeeks.com/how-to-create-and-configure-bridge-networking-for-kvm-in-linux/"
    className="reset"
  />
- <ScreenshotLink
    url="https://linuxconfig.org/how-to-use-bridged-networking-with-libvirt-and-kvm"
    text="https://linuxconfig.org/how-to-use-bridged-networking-with-libvirt-and-kvm"
    className="reset"
  />
