...
- [https://wiki.archlinux.org/title/libvirt#Management](https://wiki.archlinux.org/title/libvirt#Management)
- [https://linux.die.net/man/1/virt-install](https://linux.die.net/man/1/virt-install)
- [https://computingforgeeks.com/how-to-create-and-configure-bridge-networking-for-kvm-in-linux/](https://computingforgeeks.com/how-to-create-and-configure-bridge-networking-for-kvm-in-linux/)
