const Footer = () => {
  return (
    <footer className="fixed bottom-0 w-full sm:max-w-screen-sm md:max-w-5xl">
      <div className="max-w flex px-4 py-8">
        <a
          href="https://github.com/ndom91"
          target="_blank"
          className="dark:focus:ring-opacity-10 dark:focus:ring-pink-500 dark:text-gray-100 text-gray-800 rounded focus:outline-none transition-shadow duration-500 focus:ring-pink-400 focus:ring-opacity-30 focus:ring-4"
        >
          <svg
            width="32"
            height="32"
