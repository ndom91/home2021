...
;(function () {
  ...
  const trackQuerystring = scriptTag.getAttribute("data-track-query") !== "false"
  const trackOutbound = scriptTag.getAttribute("data-track-outbound") !== "false"
  ...
  const debouncedTrackPageview =
    debounceDuration > 0 ? debounce(trackPageview, debounceDuration) : trackPageview
