...
const IntroDescription = () => (
  <div
    className="relative p-2 mt-4 w-full text-lg font-thin text-left text-gray-800 md:text-xl lg:pl-10 lg:w-11/12 dark:text-gray-100 font-victor leading-[2.75rem] animate-[var(--animation-fade-in-bloom)]"
