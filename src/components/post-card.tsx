...
const PostCard = ({ post }: Props) => {
  ...
  return (
    <div className="flex relative flex-col w-full md:my-4 md:max-w-md">
      <div className="flex flex-col gap-3 p-8 bg-white rounded-xl shadow-sm dark:bg-gray-700">
        <div className="overflow-hidden h-40 rounded-t-lg mask-bottom-strong">
          ...
          {url?.includes("checklyhq.com") ? (
            <div
              className="absolute top-10 right-10 z-20 p-2 bg-gray-100 rounded-full dark:bg-gray-700"
              title="External"
            >
              <svg
