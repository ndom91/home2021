...
const S = new Map([
  ...
  C = ["class", "style"],
  M = ["show-unsupported", "show-metric-name"]
class F extends HTMLElement {
  ...
  getMetricAttributes() {
    return this.getAttributeNames()
      .filter((e) => !C.includes(e) && !M.includes(e))
      .map((e) => e.toUpperCase())
  }
  getMetrics(e) {
    return new Map(
  ...
  render() {
    this.innerHTML = `<div class="web-vitals">\n      <dl>\n        ${[
      ...
      .map(([e, t]) => {
        ...
        let o = ""
        const { good: d, needsImprovement: u } = r
        if (s) {
          o += "is-final "
          let e = "is-poor"
          u && s <= u && (e = "needs-improvement"),
            s <= d && (e = "is-good"),
            (o += e)
        }
        return `\n            <div class="${o}">\n              <dt>\n                ${
...
!(function (e, t) {
  ...
  customElements.define("web-vitals", F)
